          ...
          <?php foreach ($this->data['categories'] as $category) { ?>
            <?php if (isset($_SESSION['admin'])){ ?>
              <form action="/post/delete" method="post">
                ...
                <a href="/post/category/<?php echo $category['name'] ?>" class="list-group-item list-group-item-action"><?php echo $category['name'] ?><span style="float:right"><button type="submit" class="btn btn-outline-danger btn-sm">X</button></span></a>
              </form>
              <?php } else { ?>
